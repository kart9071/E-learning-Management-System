...
public class UserController 
{
	...
	@GetMapping("/userlist")
	@CrossOrigin(origins = "http://localhost:4200")
	public ResponseEntity<List<Userone>> getUsers() throws Exception
	{
		List<Userone> users = userService.getAllUsers();
		return new ResponseEntity<List<Userone>>(users, HttpStatus.OK);
	}
	...
	@CrossOrigin(origins = "http://localhost:4200")
	public ResponseEntity<List<Userone>> getProfileDetails(@PathVariable String email) throws Exception
	{
		List<Userone> users = userService.fetchProfileByEmail(email);
		return new ResponseEntity<List<Userone>>(users, HttpStatus.OK);
	}
	
	@PutMapping("/updateuser")
	@CrossOrigin(origins = "http://localhost:4200")
	public ResponseEntity<Userone> updateUserProfile(@RequestBody Userone user) throws Exception
	{
		Userone userobj = userService.updateUserProfile(user);
		return new ResponseEntity<Userone>(userobj, HttpStatus.OK);
	}
	...
	@GetMapping("/acceptstatus1/{email}")
	@CrossOrigin(origins = "http://localhost:4200")
